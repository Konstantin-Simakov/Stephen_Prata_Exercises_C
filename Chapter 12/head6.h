/* head6.h -- Chapter 12 */
/* this header file -- for exercise6.c (and suppoert6.c if it is necessary) */

#define SIZE 	 10					// range of values -- from 1 to SIZE
#define GENERATE 1000				// number of generated values
